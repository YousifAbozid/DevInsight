...
export default function MonochromeBusinessTheme({
  ...
  return (
    <div
      className="w-full max-w-md bg-white rounded-lg shadow-md transition-all duration-300"
      style={{
        boxShadow: isHovered
      ...
      <div className="p-6">
        ...
        <div className="flex items-center mb-6 pb-5 border-b border-gray-200">
          <img
            src={user.avatar_url}
            alt={user.login}
            className="w-16 h-16 rounded-full grayscale object-cover mr-4 border border-gray-200"
          />
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              ...
              <div className="text-xs text-gray-500 uppercase mt-1">Issues</div>
            </div>
          </div>
        </div>
